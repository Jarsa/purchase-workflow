...
class ProcurementRule(models.Model):
    ...
    def _make_po_select_supplier(self, values, suppliers):
        """Method overridden from odoo to add supplier to values if you need to
        override this method, you must ensure to pass the new supplier to
        values['supplier'] = new_supplier"""
    ...
    def _prepare_purchase_order_line(
        ...
        seller = product_id.with_context(
                currency_id=supplier.currency_id.id)._select_seller(
            partner_id=partner,
